function ConW = main_hierarchical_rollback(f,cTS,hc,cW0,aTS,ha,aW0,UB, rb_threshold)
N = length(cW0);
is_solved = 0;
if ~isempty(cW0)
    aW0 = zeros(1,N);
...
%                 HC(t) = HC(t) + 5;
            ...
            fa = absW(t+1,:);
            ta2c = tic;
            [conWt, infeasibility_flag] = abs2con_rollback2(aTS, ia, fa, cTS, ic, fc, HC(t), rb_constraints{t});
            if conWt(1) == -1
